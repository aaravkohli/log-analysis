import { type LogEntry } from './dataManager';
...
class LogFilterManager {
  ...
  filterLogs(logEntries: LogEntry[], filter: LogFilter): LogEntry[] {
  ...
  getUniqueCountries(logEntries: LogEntry[]): string[] {
  ...
  getUniqueUsers(logEntries: LogEntry[]): string[] {
  ...
  getUniqueIPs(logEntries: LogEntry[]): string[] {
